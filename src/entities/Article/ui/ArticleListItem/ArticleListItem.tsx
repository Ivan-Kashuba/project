        ...
        return (
            <div className={classNames(cls.ArticleListItem, {}, [className, cls[view]])} data-testid="ArticleListItem">
                <Card>
                    ...
                    {types}
                    <AppImage fallback={<Skeleton width="100%" height={250} />} src={article.img} alt="#" className={cls.img} />
        ...
        >
            <Card>
                <div className={cls.imageWrapper}>
                    <AppImage fallback={<Skeleton width={200} height={200} />} src={article.img} alt="#" className={cls.img} />
                    <Text text={article.createdAt} className={cls.date} />
                </div>
